...
<Theorem id="9.1.1" title="Realizability">
...
<Theorem id="9.2.1" title="Zero-State Equivalence Condition">
...
<Theorem id="9.2.2" title="Algebraic Implies Zero-State Equivalence">
...
<Example id="9.4.1" title="Canonical Realizations">
...
<Example id="9.4.2" title="Non-Rational Transfer Function">
