...
$$u = M\frac{d^2y}{dt^2} + m\frac{d^2}{dt^2}(y + l\sin(\theta)) = M\frac{d^2y}{dt^2} + m\frac{d^2y}{dt^2} + ml\cos(\theta)\frac{d^2\theta}{dt^2} - ml\left(\frac{d\theta}{dt}\right)^2\sin(\theta) \qquad \text{}$$
...
$$l\frac{d^2\theta}{dt^2} = g\theta - \frac{d^2y}{dt^2} \qquad \text{}$$
