...
Then, realize that $e^{\lambda_i t}c$ (for some constant $c$) solves the differential and thus obtain a solution for the eigenvalue equation:
...
The proof then follows from . $\square$
</Proof>
