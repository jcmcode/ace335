...
<Theorem id="8.3.1" title="Continuous Dependence of Roots on Parameters">
...
<Example id="8.3.1" title="Root Locus for Double Integrator">
Consider Figure 8.4.
...
<Theorem id="8.4.1" title="Nyquist Criterion">
...
<Theorem id="8.4.2" title="Principle of Variation of the Argument">
...
<Theorem id="8.4.3" title="Small Gain Theorem">
...
## 8.5 Predictive and Feedforward Control
...
## 8.5.1 The Routh-Hurwitz Stability Criterion
...
<Theorem id="8.5.1" title="Necessary Condition for Stability">
...
<Definition id="8.5.1" title="Routh Table">
...
where each subsequent entry is computed by a $2 \times 2$ determinant divided by the leading element of the row above:
...
<Theorem id="8.5.2" title="Routh-Hurwitz Criterion">
...
<Example id="8.5.1" title="Routh-Hurwitz for a Third-Order System">
...
<Example id="8.5.2" title="Routh-Hurwitz with a Gain Parameter">
