...
<Definition id="4.1" title="Memorylessness">
...
<Definition id="4.2" title="Causality (Non-anticipativeness)">
...
<Example id="4.1" title="Causal and Memoryless Systems">
...
<Definition id="4.3" title="Time-Invariance">
...
<Definition id="4.4" title="Linear System (DT)">
A discrete-time (DT) system is **linear** if the input-output relation can be written as:

$$y(n) = \sum_{m=-\infty}^{\infty} h(n, m) u(m). \qquad \text{(4.1)}$$
...
Building on this discussion, one takes the representation above as a definition of a linear system: In our course and in standard terminology in engineering and applied science, we generally say that a discrete-time (DT) system is linear if the input-output relation can be written as (4.1).
...
$$y(n) = \sum_m k(n, m) u(m), \qquad \text{(4.3)}$$
...
<Definition id="4.7" title="Impulse Response (CT)">
...
<Definition id="4.8" title="BIBO Stability (DT)">
...
<Definition id="4.9" title="BIBO Stability (CT)">
...
<Theorem id="4.4.1" title="BIBO Stability of Convolution Systems">
...
<Definition id="4.10" title="Frequency Response (CT)">
We define
...
<Definition id="4.11" title="Frequency Response (DT)">
...
<Definition id="4.12" title="Transfer Function">
The map
...
<Definition id="4.13" title="State of a System">
...
<Theorem id="4.9.1" title="BIBO Stability via Eigenvalues (CT)">
...
<Theorem id="4.9.2" title="BIBO Stability via Eigenvalues (DT)">
...
### Exercise 4.10.6 (Stability of Linear Time-Varying Systems)
