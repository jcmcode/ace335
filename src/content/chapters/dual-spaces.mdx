...
## 3.2 Dual Space of a Normed Linear Space
...
<Theorem id="3.2.1" title="Bounded iff Continuous">
...
<Theorem id="3.2.2" title="Riesz Representation Theorem">
...
<Theorem id="3.2.3" title="Riesz Representation Theorem for Hilbert Spaces">
...
<Definition id="3.2.1" title="Weak Convergence">
...
<Definition id="3.2.2" title="Weak* Convergence">
...
### 3.3.1 Space $\mathcal{D}$ and $\mathcal{S}$ of Test Functions
...
<Definition id="3.3.1" title="Schwartz Function Space S">
...
<Definition id="3.3.2" title="Distribution">
...
<Definition id="3.3.3" title="Tempered Function">
...
<Theorem id="3.3.1" title="Dirac Delta is a Distribution">
...
<Definition id="3.3.4" title="Convergence of Distributions">
...
<Example id="3.3.1" title="Regular Distributions Converging to the Dirac Delta">
...
## 3.4 Approximate Identity Sequences

<ApproximateIdentityDemo />

<Definition id="3.4.1" title="Approximate Identity Sequence">
...
<Theorem id="3.4.1" title="Approximate Identity Sequences Converge to delta">
...
### 3.4.1 Examples of Approximate Identity Sequences

<Example id="3.4.1" title="Rectangle Approximate Identity">
...
<Example id="3.4.2" title="Gaussian Approximate Identity">
...
<Theorem id="3.4.2" title="Cosine Approximate Identity (Proposition 3.4.1)">
...
<Example id="3.4.3" title="Sinc Approximate Identity">
...
<Theorem id="3.4.3" title="Sinc Sequence Converges to delta">
...
### 3.4.2 Convolution and its use in approximations
...
<Theorem id="3.4.4" title="Approximate Identity Convolution">
...
<Corollary id="3.4.1" title="Density of Smooth Functions">
...
### 3.4.3 Completeness of complex exponentials in $L_2([-\pi, \pi]; \mathbb{C})$
...
<Theorem id="3.4.5" title="Completeness of Complex Exponentials">
...
## 3.5 Some Operations on Distributions [Optional]
...
<Definition id="3.5.1" title="Derivative of a Distribution">
...
<Example id="3.5.1" title="Derivative of the Step Function Distribution">
...
<Theorem id="3.5.1" title="Convolution with a Distribution">
...
## 3.6 Fourier Transform of Schwartz Functions
...
### 3.7.1 Optional: Application to Optimization Problems and the Generalization of the Projection Theorem
...
<Theorem id="3.7.1" title="Distance and Dual Characterization (Projection Generalization)">
...
<Theorem id="3.7.2" title="Dual Distance Characterization">
